...
class Ui_WidgetPump(object):
    def setupUi(self, WidgetPump):
        ...
        self.gridLayout.addWidget(self.spin_target, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_get, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self._label_5, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self._label_3, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_diameter, 9, 2, 1, 1)
        self.spin_rate = QtWidgets.QDoubleSpinBox(WidgetPump)
        self.spin_rate.setMinimumSize(QtCore.QSize(97, 20))
        ...
        item = QtWidgets.QListWidgetItem()
        self.list_baud.addItem(item)
        self.gridLayout.addWidget(self.list_baud, 2, 1, 11, 1)
        self._label_4 = QtWidgets.QLabel(WidgetPump)
        self._label_4.setMinimumSize(QtCore.QSize(97, 13))
        self._label_4.setObjectName("_label_4")
        self.gridLayout.addWidget(self._label_4, 6, 2, 1, 1)
        self.combo_units = QtWidgets.QComboBox(WidgetPump)
        self.combo_units.setMinimumSize(QtCore.QSize(97, 20))
        self.combo_units.setObjectName("combo_units")
        self.combo_units.addItem("")
        self.combo_units.addItem("")
        self.combo_units.addItem("")
        self.combo_units.addItem("")
        self.gridLayout.addWidget(self.combo_units, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_conn, 13, 2, 1, 1)
        self.list_port = QtWidgets.QListWidget(WidgetPump)
        self.list_port.setObjectName("list_port")
        self.gridLayout.addWidget(self.list_port, 2, 0, 11, 1)
        ...
        self.gridLayout.addWidget(self.label_baud, 13, 1, 1, 1)
        ...
        self._label_4.setBuddy(self.combo_units)
    ...
    def retranslateUi(self, WidgetPump):
        ...
        self._label_4.setText(_translate("WidgetPump", "Units"))
