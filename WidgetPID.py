...
class Ui_WidgetPID(object):
    def setupUi(self, WidgetPID):
        ...
        self.gridLayout.addWidget(self.frame, 10, 2, 1, 1)
        ...
        self.gridLayout.addLayout(self.layout_graph, 0, 0, 12, 1)
        ...
        self.gridLayout.addWidget(self.btn_start, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidget, 9, 2, 1, 1)
