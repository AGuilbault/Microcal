...
class Ui_WidgetPID(object):
    def setupUi(self, WidgetPID):
        ...
        self.gridLayout.addWidget(self.spin_ti, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_setpoint, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_td, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_kc, 4, 1, 1, 1)
        self._label_4 = QtWidgets.QLabel(WidgetPID)
        self._label_4.setObjectName("_label_4")
        self.gridLayout.addWidget(self._label_4, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self._line, 2, 1, 1, 1)
        self._label_1 = QtWidgets.QLabel(WidgetPID)
        self._label_1.setObjectName("_label_1")
        self.gridLayout.addWidget(self._label_1, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_clear, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.wid_graph, 0, 0, 12, 1)
